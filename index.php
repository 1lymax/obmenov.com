...
while ( $currency_row = $query->fetch_assoc() ) {
?>
...
<div class="otzyv"></div><?php */?>
<?php /*?><h1>Obmenov.biz - сервис по обмену, вводу и выводу других электронных валют.</h1>
...
<h1>Obmenov.biz - ввод, вывод PerfectMoney.</h1>
 <div class="otzyv"></div><?php */?>
...
<p>За подробностями обращайтесь в <a href="<?=$siteroot?>contacts.php">техподдержку сервиса</a>.</p>
<div class="otzyv"></div><?php */?>
 <?php /*?><h1>Обменов.ком - сервис по обмену, вводу и выводу остальных валют.</h1>
<a href="https://obmenov.com">Перейти на сайт Обменов.ком</a></p><?php */?>
  <?php } ?>
  <div class="otzyv"></div>
...
<div class="otzyv"></div><?php */?>
                        ...
                        <div class="intro">
                            <?php /*?><h1>Новости <?=get_setting('site_title_sht'.$urlid['site_curr2'])?></h1>
