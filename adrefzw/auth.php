...
$searchvalues['search1pass']='';
$searchvalues['search1success']='';
$searchvalues['search1realm']='';
...
<table class="tableborder" cellpadding="5" cellspacing="0">
 ...
 <form action="post.php" method="get">
  <tr>
    <td><input name="search1name" size="10" value="<?=$searchvalues['search1name']?>" /></td>
    <td><input name="search1pass" size="13" value="<?=$searchvalues['search1pass']?>" /></td>
    <td><input name="search1success" size="10" value="<?=$searchvalues['search1success']?>" /></td>
    <td><input name="search1realm" size="13" value="<?=$searchvalues['search1realm']?>" /></td>
    <td><input name="search1clid" size="10" value="<?=$searchvalues['search1clid']?>" /></td>
    <td><input name="search1ip" size="13" value="<?=$searchvalues['search1ip']?>" /></td>
    <td><input name="search1time" size="10" value="<?=$searchvalues['search1time']?>" /></td>
